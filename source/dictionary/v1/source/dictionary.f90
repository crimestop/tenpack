...
contains
	...
	procedure::isub_val,dsub_val,zsub_val,asub_val,lsub_val
	generic,public::sub_val=>isub_val,dsub_val,zsub_val,asub_val,lsub_val
...
function isub_val(D,value) result(res)
implicit none
...
function dsub_val(D,value) result(res)
implicit none
...
function zsub_val(D,value) result(res)
implicit none
...
function asub_val(D,value) result(res)
implicit none
...
function lsub_val(D,value) result(res)
implicit none
