...
!			norm(Tr):return  sqrt(<phi|phi>)
		...
		generic,public::SVD     =>SVDcutoff,SVDcutoff_name,SVDTensor_Leg1_Routine,SVDTensor_Leg2_Routine,SVDTensor_Leg1_Routine_
...
!			 T=res(1)*res(res(2))*res(3)
		...
		generic,public::QR     => QRdecomposition1,QRTensor_Leg1_Routine,QRTensor_Leg2_Routine
...
!			 T=res(1)*res(2)		
		...
		generic,public::LQ     => LQdecomposition1,LQTensor_Leg2_Routine,LQTensor_Leg1_Routine
