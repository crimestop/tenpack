...
module Dimension_typede
	...
	contains 
		...
		procedure,public::out_sample_flag=>out_sample_dimension_flag
...
!**********************************************************	
	...
	public::Dimension_memory_report,Dimension_memory_length
	contains
   ...
   integer function outDimNameLen()
	...
	logical function out_sample_dimension_flag(dimen)
   	class(Dimension),intent(in)::dimen
		out_sample_dimension_flag=dimen%sample_dimension_flag
		return
	end function
