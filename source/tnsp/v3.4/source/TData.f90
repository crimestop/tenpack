...
!end subroutine!
	...
	public::TData_memory_report,TData_memory_length
contains
...
!**************************************************************************************************************
!**************************************************************************************************************
	subroutine modify_TData_class(T,dimen,LDdimen,rank,newdata)
		class(TData),intent(inout)::T
		integer,intent(in)::rank
		integer,intent(in)::dimen(rank),LDdimen(rank)
		class(*),intent(in)::newdata
		select case(rank)
			case(1)
				select case (T%classtype)
					case(1)
						call modifyTen_val_dim1_int(dimen(1),T%idata,T%totalData,newdata)
					case(2)
						call modifyTen_val_dim1_real4(dimen(1),T%sdata,T%totalData,newdata)	
					case(3)
						call modifyTen_val_dim1_real8(dimen(1),T%ddata,T%totalData,newdata)	
					case(4)
						call modifyTen_val_dim1_com4(dimen(1),T%cdata,T%totalData,newdata)	
					case(5)
						call modifyTen_val_dim1_com8(dimen(1),T%zdata,T%totalData,newdata)	
					case(6)
						call modifyTen_val_dim1_logi(dimen(1),T%ldata,T%totalData,newdata)	
					case(7)
						call modifyTen_val_dim1_char(dimen(1),T%adata,T%totalData,newdata)	
				end select
			case(2)
				select case (T%classtype)
					case(1)
						call modifyTen_val_dim2_int(dimen(1),dimen(2),T%idata,LDdimen(1),LDdimen(2),newdata)
					case(2)
						call modifyTen_val_dim2_real4(dimen(1),dimen(2),T%sdata,LDdimen(1),LDdimen(2),newdata)	
					case(3)
						call modifyTen_val_dim2_real8(dimen(1),dimen(2),T%ddata,LDdimen(1),LDdimen(2),newdata)	
					case(4)
						call modifyTen_val_dim2_com4(dimen(1),dimen(2),T%cdata,LDdimen(1),LDdimen(2),newdata)	
					case(5)
						call modifyTen_val_dim2_com8(dimen(1),dimen(2),T%zdata,LDdimen(1),LDdimen(2),newdata)	
					case(6)
						call modifyTen_val_dim2_logi(dimen(1),dimen(2),T%ldata,LDdimen(1),LDdimen(2),newdata)	
					case(7)
						call modifyTen_val_dim2_char(dimen(1),dimen(2),T%adata,LDdimen(1),LDdimen(2),newdata)	
				end select
			case(3)
				select case (T%classtype)
					case(1)
						call modifyTen_val_dim3_int(dimen(1),dimen(2),dimen(3),T%idata,LDdimen(1),LDdimen(2),LDdimen(3),newdata)
					case(2)
						call modifyTen_val_dim3_real4(dimen(1),dimen(2),dimen(3),T%sdata,LDdimen(1),LDdimen(2),LDdimen(3),newdata)	
					case(3)
						call modifyTen_val_dim3_real8(dimen(1),dimen(2),dimen(3),T%ddata,LDdimen(1),LDdimen(2),LDdimen(3),newdata)	
					case(4)
						call modifyTen_val_dim3_com4(dimen(1),dimen(2),dimen(3),T%cdata,LDdimen(1),LDdimen(2),LDdimen(3),newdata)	
					case(5)
						call modifyTen_val_dim3_com8(dimen(1),dimen(2),dimen(3),T%zdata,LDdimen(1),LDdimen(2),LDdimen(3),newdata)	
					case(6)
						call modifyTen_val_dim3_logi(dimen(1),dimen(2),dimen(3),T%ldata,LDdimen(1),LDdimen(2),LDdimen(3),newdata)
					case(7)
						call modifyTen_val_dim3_char(dimen(1),dimen(2),dimen(3),T%adata,LDdimen(1),LDdimen(2),LDdimen(3),newdata)	
				end select
			case(4)
				select case (T%classtype)
					case(1)
						call modifyTen_val_dim4_int(dimen(1),dimen(2),dimen(3),dimen(4),T%idata,LDdimen(1),LDdimen(2),&
																	LDdimen(3),LDdimen(4),newdata)
					case(2)
						call modifyTen_val_dim4_real4(dimen(1),dimen(2),dimen(3),dimen(4),T%sdata,LDdimen(1),LDdimen(2),&
																	LDdimen(3),LDdimen(4),newdata)
					case(3)
						call modifyTen_val_dim4_real8(dimen(1),dimen(2),dimen(3),dimen(4),T%ddata,LDdimen(1),LDdimen(2),&
																	LDdimen(3),LDdimen(4),newdata)
					case(4)
						call modifyTen_val_dim4_com4(dimen(1),dimen(2),dimen(3),dimen(4),T%cdata,LDdimen(1),LDdimen(2),&
																	LDdimen(3),LDdimen(4),newdata)
					case(5)
						call modifyTen_val_dim4_com8(dimen(1),dimen(2),dimen(3),dimen(4),T%zdata,LDdimen(1),LDdimen(2),&
																	LDdimen(3),LDdimen(4),newdata)
					case(6)
						call modifyTen_val_dim4_logi(dimen(1),dimen(2),dimen(3),dimen(4),T%ldata,LDdimen(1),LDdimen(2),&
																	LDdimen(3),LDdimen(4),newdata)
					case(7)
						call modifyTen_val_dim4_char(dimen(1),dimen(2),dimen(3),dimen(4),T%adata,LDdimen(1),LDdimen(2),&
																	LDdimen(3),LDdimen(4),newdata)
				end select
	...
	subroutine modify_TData_char(T,dimen,LDdimen,rank,newdata)
		class(TData),intent(inout)::T
		integer,intent(in)::rank
		integer,intent(in)::dimen(rank),LDdimen(rank)
		...
		select case(rank)
			case(1)
				select case (T%classtype)
					case(7)
						call modifyTen_val_dim1_character(dimen(1),T%adata,T%totalData,newdata)	
				end select
			case(2)
				select case (T%classtype)
					case(7)
						call modifyTen_val_dim2_character(dimen(1),dimen(2),T%adata,LDdimen(1),LDdimen(2),newdata)	
				end select
			case(3)
				select case (T%classtype)
					case(7)
						call modifyTen_val_dim3_character(dimen(1),dimen(2),dimen(3),T%adata,LDdimen(1),LDdimen(2),LDdimen(3),newdata)	
				end select
			case(4)
				select case (T%classtype)
					case(7)
						call modifyTen_val_dim4_character(dimen(1),dimen(2),dimen(3),dimen(4),T%adata,LDdimen(1),LDdimen(2),&
																	LDdimen(3),LDdimen(4),newdata)
				end select
...
!A(i:j)=B(i:j)
	subroutine modify_Some_TData_class1(T,Tdimen,ia,newdata,Ndimen,ib)
		integer,intent(in)::Tdimen,Ndimen,ia(2),ib(2)
		type(TData),intent(inout)::T
		class(*),intent(in)::newdata(Ndimen)
		select case(T%classtype)
			case(1)
				call store_value_int(T%idata,Tdimen,ia,newdata,Ndimen,ib)
			case(2)
				call store_value_real4(T%sdata,Tdimen,ia,newdata,Ndimen,ib)
			case(3)
				call store_value_real8(T%ddata,Tdimen,ia,newdata,Ndimen,ib)
			case(4)
				call store_value_com4(T%cdata,Tdimen,ia,newdata,Ndimen,ib)
			case(5)
				call store_value_com8(T%zdata,Tdimen,ia,newdata,Ndimen,ib)
			case(6)	
				call store_value_logi(T%ldata,Tdimen,ia,newdata,Ndimen,ib)
			case default
	...
	subroutine modify_Some_TData_char1(T,Tdimen,ia,newdata,Ndimen,ib)
		integer,intent(in)::Tdimen,Ndimen,ia(2),ib(2)
		type(TData),intent(inout)::T
		character(len=*),intent(in)::newdata(Ndimen)
		select case(T%classtype)
			case(7)
				call store_value_char(T%adata,Tdimen,ia,newdata,Ndimen,ib)
			case default
				call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
				call error_stop()
		end select
	...
	subroutine modify_Some_TData_TData1(T,Tdimen,ia,B,Ndimen,ib)
		...
		select case(B%classtype)
			...
			case(7)	
				call modify_Some_TData_char1(T,Tdimen,ia,B%adata,Ndimen,ib)
			case default
				call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
				call error_stop()
		end select
...
!A(i1:i2,j1:j2)=B(i1:i2,j1:j2)	
	subroutine modify_Some_TData_class2(T,TD,ia,ja,newdata,ND,ib,jb)
		integer,intent(in)::TD(2),ND(2),ia(2),ja(2),ib(2),jb(2)
		type(TData),intent(inout)::T
		class(*),intent(in)::newdata(ND(1),ND(2))
		select case(T%classtype)
			case(1)
				call store_value2_int(T%idata,TD(1),TD(2),ia,ja,newdata,ND(1),ND(2),ib,jb)
			case(2)
				call store_value2_real4(T%sdata,TD(1),TD(2),ia,ja,newdata,ND(1),ND(2),ib,jb)
			case(3)
				call store_value2_real8(T%ddata,TD(1),TD(2),ia,ja,newdata,ND(1),ND(2),ib,jb)
			case(4)
				call store_value2_com4(T%cdata,TD(1),TD(2),ia,ja,newdata,ND(1),ND(2),ib,jb)
			case(5)
				call store_value2_com8(T%zdata,TD(1),TD(2),ia,ja,newdata,ND(1),ND(2),ib,jb)
			case(6)	
				call store_value2_logi(T%ldata,TD(1),TD(2),ia,ja,newdata,ND(1),ND(2),ib,jb)
			case default
				call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
				call error_stop()
		end select
	...
	subroutine modify_Some_TData_char2(T,TD,ia,ja,newdata,ND,ib,jb)
		integer,intent(in)::TD(2),ND(2),ia(2),ja(2),ib(2),jb(2)
		type(TData),intent(inout)::T
		character(len=*),intent(in)::newdata(ND(1),ND(2))
		select case(T%classtype)
			case(7)
				call store_value2_char(T%adata,TD(1),TD(2),ia,ja,newdata,ND(1),ND(2),ib,jb)
			case default
				call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
				call error_stop()
		end select
	...
	subroutine modify_Some_TData_TData2(T,TD,ia,ja,B,ND,ib,jb)
		...
		select case(T%classtype)
			case(1)
				select case(B%classtype)
					case(1)
						call store_value2_int_int(T%idata,TD(1),TD(2),ia,ja,B%idata,ND(1),ND(2),ib,jb)
					case(2)
						call store_value2_int_real4(T%idata,TD(1),TD(2),ia,ja,B%sdata,ND(1),ND(2),ib,jb)
					case(3)
						call store_value2_int_real8(T%idata,TD(1),TD(2),ia,ja,B%ddata,ND(1),ND(2),ib,jb)
					case(4)
						call store_value2_int_com4(T%idata,TD(1),TD(2),ia,ja,B%cdata,ND(1),ND(2),ib,jb)
					case(5)
						call store_value2_int_com8(T%idata,TD(1),TD(2),ia,ja,B%zdata,ND(1),ND(2),ib,jb)
					case default
						call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
						call error_stop()
				end select
			...
			case(2)
				select case(B%classtype)
					case(1)
						call store_value2_real4_int(T%sdata,TD(1),TD(2),ia,ja,B%idata,ND(1),ND(2),ib,jb)
					case(2)
						call store_value2_real4_real4(T%sdata,TD(1),TD(2),ia,ja,B%sdata,ND(1),ND(2),ib,jb)
					case(3)
						call store_value2_real4_real8(T%sdata,TD(1),TD(2),ia,ja,B%ddata,ND(1),ND(2),ib,jb)
					case(4)
						call store_value2_real4_com4(T%sdata,TD(1),TD(2),ia,ja,B%cdata,ND(1),ND(2),ib,jb)
					case(5)
						call store_value2_real4_com8(T%sdata,TD(1),TD(2),ia,ja,B%zdata,ND(1),ND(2),ib,jb)
					case default
						call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
						call error_stop()
				end select
			...
			case(3)
				select case(B%classtype)
					case(1)
						call store_value2_real8_int(T%ddata,TD(1),TD(2),ia,ja,B%idata,ND(1),ND(2),ib,jb)
					case(2)
						call store_value2_real8_real4(T%ddata,TD(1),TD(2),ia,ja,B%sdata,ND(1),ND(2),ib,jb)
					case(3)
						call store_value2_real8_real8(T%ddata,TD(1),TD(2),ia,ja,B%ddata,ND(1),ND(2),ib,jb)
					case(4)
						call store_value2_real8_com4(T%ddata,TD(1),TD(2),ia,ja,B%cdata,ND(1),ND(2),ib,jb)
					case(5)
						call store_value2_real8_com8(T%ddata,TD(1),TD(2),ia,ja,B%zdata,ND(1),ND(2),ib,jb)
					case default
						call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
						call error_stop()
				end select
			...
			case(4)
				select case(B%classtype)
					case(1)
						call store_value2_com4_int(T%cdata,TD(1),TD(2),ia,ja,B%idata,ND(1),ND(2),ib,jb)
					case(2)
						call store_value2_com4_real4(T%cdata,TD(1),TD(2),ia,ja,B%sdata,ND(1),ND(2),ib,jb)
					case(3)
						call store_value2_com4_real8(T%cdata,TD(1),TD(2),ia,ja,B%ddata,ND(1),ND(2),ib,jb)
					case(4)
						call store_value2_com4_com4(T%cdata,TD(1),TD(2),ia,ja,B%cdata,ND(1),ND(2),ib,jb)
					case(5)
						call store_value2_com4_com8(T%cdata,TD(1),TD(2),ia,ja,B%zdata,ND(1),ND(2),ib,jb)
					case default
						call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
						call error_stop()
				end select	
			...
			case(5)
				select case(B%classtype)
					case(1)
						call store_value2_com8_int(T%zdata,TD(1),TD(2),ia,ja,B%idata,ND(1),ND(2),ib,jb)
					case(2)
						call store_value2_com8_real4(T%zdata,TD(1),TD(2),ia,ja,B%sdata,ND(1),ND(2),ib,jb)
					case(3)
						call store_value2_com8_real8(T%zdata,TD(1),TD(2),ia,ja,B%ddata,ND(1),ND(2),ib,jb)
					case(4)
						call store_value2_com8_com4(T%zdata,TD(1),TD(2),ia,ja,B%cdata,ND(1),ND(2),ib,jb)
					case(5)
						call store_value2_com8_com8(T%zdata,TD(1),TD(2),ia,ja,B%zdata,ND(1),ND(2),ib,jb)
					case default
						call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
						call error_stop()
				end select	
			...
			case(6)
				select case(B%classtype)
				case(6)
						call store_value2_logi_logi(T%ldata,TD(1),TD(2),ia,ja,B%ldata,ND(1),ND(2),ib,jb)
					case default
						call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
						call error_stop()
				end select	
			...
			case(7)
				select case(B%classtype)
				case(7)
						call store_value2_char(T%adata,TD(1),TD(2),ia,ja,B%adata,ND(1),ND(2),ib,jb)
					case default
						call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
						call error_stop()
				end select	
	...
	subroutine modify_Some_TData_class3(T,TD,ia,ja,ka,newdata,ND,ib,jb,kb)
		integer,intent(in)::TD(3),ND(3),ia(2),ja(2),ka(2),ib(2),jb(2),kb(2)
		type(TData),intent(inout)::T
		class(*),intent(in)::newdata(ND(1),ND(2),ND(3))
		select case(T%classtype)
			case(1)
				call store_value3_int(T%idata,TD(1),TD(2),TD(3),ia,ja,ka,newdata,ND(1),ND(2),ND(3),ib,jb,kb)
			case(2)
				call store_value3_real4(T%sdata,TD(1),TD(2),TD(3),ia,ja,ka,newdata,ND(1),ND(2),ND(3),ib,jb,kb)
			case(3)
				call store_value3_real8(T%ddata,TD(1),TD(2),TD(3),ia,ja,ka,newdata,ND(1),ND(2),ND(3),ib,jb,kb)
			case(4)
				call store_value3_com4(T%cdata,TD(1),TD(2),TD(3),ia,ja,ka,newdata,ND(1),ND(2),ND(3),ib,jb,kb)
			case(5)
				call store_value3_com8(T%zdata,TD(1),TD(2),TD(3),ia,ja,ka,newdata,ND(1),ND(2),ND(3),ib,jb,kb)
			case(6)	
				call store_value3_logi(T%ldata,TD(1),TD(2),TD(3),ia,ja,ka,newdata,ND(1),ND(2),ND(3),ib,jb,kb)
			case default
				call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
				call error_stop()
		end select
	...
	subroutine modify_Some_TData_char3(T,TD,ia,ja,ka,newdata,ND,ib,jb,kb)
		integer,intent(in)::TD(3),ND(3),ia(2),ja(2),ka(2),ib(2),jb(2),kb(2)
		type(TData),intent(inout)::T
		character(len=*),intent(in)::newdata(ND(1),ND(2),ND(3))
		select case(T%classtype)
			case(7)
				call store_value3_char(T%adata,TD(1),TD(2),TD(3),ia,ja,ka,newdata,ND(1),ND(2),ND(3),ib,jb,kb)
			case default
				call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
				call error_stop()
		end select
	...
	subroutine modify_Some_TData_class4(T,TD,ia,ja,ka,la,newdata,ND,ib,jb,kb,lb)
		integer,intent(in)::TD(4),ND(4),ia(2),ja(2),ka(2),la(2),ib(2),jb(2),kb(2),lb(2)
		type(TData),intent(inout)::T
		class(*),intent(in)::newdata(ND(1),ND(2),ND(3),ND(4))
		select case(T%classtype)
			case(1)
				call store_value4_int(T%idata,TD(1),TD(2),TD(3),TD(4),ia,ja,ka,la,newdata,ND(1),ND(2),ND(3),ND(4),ib,jb,kb,la)
			case(2)
				call store_value4_real4(T%sdata,TD(1),TD(2),TD(3),TD(4),ia,ja,ka,la,newdata,ND(1),ND(2),ND(3),ND(4),ib,jb,kb,la)
			case(3)
				call store_value4_real8(T%ddata,TD(1),TD(2),TD(3),TD(4),ia,ja,ka,la,newdata,ND(1),ND(2),ND(3),ND(4),ib,jb,kb,la)
			case(4)
				call store_value4_com4(T%cdata,TD(1),TD(2),TD(3),TD(4),ia,ja,ka,la,newdata,ND(1),ND(2),ND(3),ND(4),ib,jb,kb,la)
			case(5)
				call store_value4_com8(T%zdata,TD(1),TD(2),TD(3),TD(4),ia,ja,ka,la,newdata,ND(1),ND(2),ND(3),ND(4),ib,jb,kb,la)
			case(6)	
				call store_value4_logi(T%ldata,TD(1),TD(2),TD(3),TD(4),ia,ja,ka,la,newdata,ND(1),ND(2),ND(3),ND(4),ib,jb,kb,la)
			case default
				call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
				call error_stop()
		end select
	...
	subroutine modify_Some_TData_char4(T,TD,ia,ja,ka,la,newdata,ND,ib,jb,kb,lb)
		integer,intent(in)::TD(4),ND(4),ia(2),ja(2),ka(2),la(2),ib(2),jb(2),kb(2),lb(2)
		type(TData),intent(inout)::T
		character(len=*),intent(in)::newdata(ND(1),ND(2),ND(3),ND(4))
		select case(T%classtype)
			case(7)
				call store_value4_char(T%adata,TD(1),TD(2),TD(3),TD(4),ia,ja,ka,la,newdata,ND(1),ND(2),ND(3),ND(4),ib,jb,kb,la)
			case default
				call writemess('ERROR in classtype when set_value in Tdata.f90',-1)
				call error_stop()
		end select
...
!character+classtype ---> max{7,classtype}	
	...
	subroutine TDatamultiply_number_int_par(Res,A,num,alpha,beta)!Res=(A*num)*alpha+beta*Res
		...
		select case(A%classtype)
			case (1)
				Res%idata=(iselect(alpha)*(A%idata*num))+(iselect(beta)*Res%idata)
			case (2)
				Res%sdata=(sselect(alpha)*(A%sdata*num))+(sselect(beta)*Res%sdata)
			case (3)
				Res%ddata=(dselect(alpha)*(A%ddata*num))+(dselect(beta)*Res%ddata)
			case (4)
				Res%cdata=(cselect(alpha)*(A%cdata*num))+(cselect(beta)*Res%cdata)
			case (5)
				Res%zdata=(zselect(alpha)*(A%zdata*num))+(zselect(beta)*Res%zdata)
		end select
		return
	end subroutine
	...
	subroutine TDatamultiply_number_real4_par(Res,A,num,alpha,beta)!Res=(A*num)*alpha+beta*Res
		...
		select case(A%classtype)
			case (1)
				Res%sdata=(sselect(alpha)*(A%idata*num))+(sselect(beta)*Res%sdata)
			case (2)
				Res%sdata=(sselect(alpha)*(A%sdata*num))+(sselect(beta)*Res%sdata)
			case (3)
				Res%ddata=(dselect(alpha)*(A%ddata*num))+(dselect(beta)*Res%ddata)
	...
	subroutine TDatamultiply_number_real8_par(Res,A,num,alpha,beta)!Res=(A*num)*alpha+beta*Res
		...
		select case(A%classtype)
			case (1)
				Res%ddata=(dselect(alpha)*(A%idata*num))+(dselect(beta)*Res%ddata)
			case (2)
				Res%ddata=(dselect(alpha)*(A%sdata*num))+(dselect(beta)*Res%ddata)
			case (3)
				Res%ddata=(dselect(alpha)*(A%ddata*num))+(dselect(beta)*Res%ddata)
			case (4)
				Res%zdata=(zselect(alpha)*(A%cdata*num))+(zselect(beta)*Res%zdata)
			case (5)
				Res%zdata=(zselect(alpha)*(A%zdata*num))+(zselect(beta)*Res%zdata)
		end select
		return
	...
	subroutine TDatamultiply_number_com4_par(Res,A,num,alpha,beta)!Res=(A*num)*alpha+beta*Res
		...
		select case(A%classtype)
			case (1)
				Res%cdata=(cselect(alpha)*(A%idata*num))+(cselect(beta)*Res%cdata)
			case (2)
				Res%cdata=(cselect(alpha)*(A%sdata*num))+(cselect(beta)*Res%cdata)
			case (3)
				Res%zdata=(zselect(alpha)*(A%ddata*num))+(zselect(beta)*Res%zdata)
			case (4)
				Res%cdata=(cselect(alpha)*(A%cdata*num))+(cselect(beta)*Res%cdata)
			case (5)
				Res%zdata=(zselect(alpha)*(A%zdata*num))+(zselect(beta)*Res%zdata)
	...
	subroutine TDatamultiply_number_com8_par(Res,A,num,alpha,beta)!Res=(A*num)*alpha+beta*Res
		...
		select case(A%classtype)
			case (1)
				Res%zdata=(zselect(alpha)*(A%idata*num))+(zselect(beta)*Res%zdata)
			case (2)
				Res%zdata=(zselect(alpha)*(A%sdata*num))+(zselect(beta)*Res%zdata)
			case (3)
				Res%zdata=(zselect(alpha)*(A%ddata*num))+(zselect(beta)*Res%zdata)
			case (4)
				Res%zdata=(zselect(alpha)*(A%cdata*num))+(zselect(beta)*Res%zdata)
...
!************************************************************************
	subroutine product_VV_dim1(R,A,B)	
		...
		complex(kind=8),External::	zdotu1
		flag=10*A%classType+B%classType
		length=A%totalData
		select case(flag)
			case(11)
			...
			case(15)
				R%zdata=zdotu1(length, dcmplx(A%idata(1:length)), 1, B%zdata, 1)
			...
			case(25)
				R%zdata=zdotu1(length, dcmplx(A%sdata(1:length)), 1, B%zdata, 1)
			...
			case(34)
				R%zdata=zdotu1(length, dcmplx(A%ddata(1:length)), 1, dcmplx(B%cdata(1:length)), 1)
			case(35)
				R%zdata=zdotu1(length, dcmplx(A%ddata(1:length)), 1, B%zdata, 1)	
			...
			case(43)
				R%zdata=zdotu1(length, dcmplx(A%cdata(1:length)), 1, dcmplx(B%ddata(1:length)), 1)
			case(44)
				R%cdata=cdotu(length, A%cdata, 1, B%cdata, 1)
			case(45)
				R%zdata=zdotu1(length, dcmplx(A%cdata(1:length)), 1, B%zdata, 1)	
				
			case(51)
				R%zdata=zdotu1(length, A%zdata, 1, dcmplx(B%idata(1:length)), 1)
			case(52)
				R%zdata=zdotu1(length, A%zdata, 1, dcmplx(B%sdata(1:length)), 1)
			case(53)
				R%zdata=zdotu1(length, A%zdata, 1, dcmplx(B%ddata(1:length)), 1)
			case(54)
				R%zdata=zdotu1(length, A%zdata, 1, dcmplx(B%cdata(1:length)), 1)
			case(55)
				R%zdata=zdotu1(length, A%zdata, 1, B%zdata, 1)	
		end select
		return
	end subroutine
	...
	subroutine product_VV_dim1_par(R,A,B,alpha,beta)!Res=alpha*A*B+beta*Res
		...
		select case(flag)
			...
			case(15)
				R%zdata=zdotu1(length, dcmplx(A%idata(1:length)), 1, B%zdata, 1)*zselect(alpha)+(R%zdata*zselect(beta))
			...
			case(25)
				R%zdata=zdotu1(length, dcmplx(A%sdata(1:length)), 1, B%zdata, 1)*zselect(alpha)+(R%zdata*zselect(beta))
			...
			case(34)
				R%zdata=zdotu1(length, dcmplx(A%ddata(1:length)), 1, dcmplx(B%cdata(1:length)), 1)*zselect(alpha)+(R%zdata*zselect(beta))
			case(35)
				R%zdata=zdotu1(length, dcmplx(A%ddata(1:length)), 1, B%zdata, 1)*zselect(alpha)+(R%zdata*zselect(beta))
			...
			case(43)
				R%zdata=zdotu1(length, dcmplx(A%cdata(1:length)), 1, dcmplx(B%ddata(1:length)), 1)*zselect(alpha)+(R%zdata*zselect(beta))
			case(44)
				R%cdata=cdotu(length, A%cdata, 1, B%cdata, 1)*cselect(alpha)+(R%cdata*cselect(beta))
			case(45)
				R%zdata=zdotu1(length, dcmplx(A%cdata(1:length)), 1, B%zdata, 1)*zselect(alpha)+(R%zdata*zselect(beta))
				
			case(51)
				R%zdata=zdotu1(length, A%zdata, 1, dcmplx(B%idata(1:length)), 1)*zselect(alpha)+(R%zdata*zselect(beta))
			case(52)
				R%zdata=zdotu1(length, A%zdata, 1, dcmplx(B%sdata(1:length)), 1)*zselect(alpha)+(R%zdata*zselect(beta))
			case(53)
				R%zdata=zdotu1(length, A%zdata, 1, dcmplx(B%ddata(1:length)), 1)*zselect(alpha)+(R%zdata*zselect(beta))
			case(54)
				R%zdata=zdotu1(length, A%zdata, 1, dcmplx(B%cdata(1:length)), 1)*zselect(alpha)+(R%zdata*zselect(beta))
			case(55)
				R%zdata=zdotu1(length, A%zdata, 1, B%zdata, 1)	*zselect(alpha)+(R%zdata*zselect(beta))
		end select
		return
	end subroutine
...
!**************************************************************************************************************
	...
	subroutine absTdata(R,A)
		...
		select case(A%classType)
			case(1)
				R%sdata=iabs(A%idata)
			case(2)
				R%sdata=abs(A%sdata)	
			case(3)
				R%sdata=dabs(A%ddata)
			case(4)
				R%sdata=cabs(A%cdata)
			case(5)
				R%sdata=cdabs(A%zdata)
		end select
		return
	end subroutine
	subroutine dabsTdata(R,A)
		...
		select case(A%classType)
			case(1)
				R%ddata=iabs(A%idata)
			case(2)
				R%ddata=abs(A%sdata)	
			case(3)
				R%ddata=dabs(A%ddata)
			case(4)
				R%ddata=cabs(A%cdata)
			case(5)
				R%ddata=cdabs(A%zdata)
		end select
		return
	end subroutine
	...
	subroutine cmplxTdata2(R,A,B)
		...
		select case(flag)
			case(11)
				R%cdata=cmplx(A%idata,B%idata,kind=4)
			case(12)
				R%cdata=cmplx(A%idata,B%sdata,kind=4)	
			case(13)
				R%cdata=cmplx(A%idata,B%ddata,kind=4)
				
			case(21)
				R%cdata=cmplx(A%sdata,B%idata,kind=4)
			case(22)
				R%cdata=cmplx(A%sdata,B%sdata,kind=4)	
			case(23)
				R%cdata=cmplx(A%sdata,B%ddata,kind=4)
				
			case(31)
				R%cdata=cmplx(A%ddata,B%idata,kind=4)
			case(32)
				R%cdata=cmplx(A%ddata,B%sdata,kind=4)	
			case(33)
				R%cdata=cmplx(A%ddata,B%ddata,kind=4)
		end select
		return
	end subroutine
	...
	subroutine dcmplxTdata2(R,A,B)
		...
		select case(flag)
			case(11)
				R%zdata=dcmplx(A%idata,B%idata)
			case(12)
				R%zdata=dcmplx(A%idata,B%sdata)	
			case(13)
				R%zdata=dcmplx(A%idata,B%ddata)
				
			case(21)
				R%zdata=dcmplx(A%sdata,B%idata)
			case(22)
				R%zdata=dcmplx(A%sdata,B%sdata)	
			case(23)
				R%zdata=dcmplx(A%sdata,B%ddata)
				
			case(31)
				R%zdata=dcmplx(A%ddata,B%idata)
			case(32)
				R%zdata=dcmplx(A%ddata,B%sdata)	
			case(33)
				R%zdata=dcmplx(A%ddata,B%ddata)
		end select
		return
	end subroutine
	subroutine aimagTdata(R,A)
		...
		select case(A%classType)
			...
			case(3)
				R%sdata(1:R%totalData)=0
			case(4)
				R%sdata=aimag(A%cdata)
			case(5)
				R%sdata=aimag(A%zdata)
		end select
		return
	end subroutine
	subroutine dimagTdata(R,A)
		...
		select case(A%classType)
			...
			case(3)
				R%ddata(1:R%totalData)=0
			case(4)
				R%ddata=aimag(A%cdata)
			case(5)
				R%ddata=aimag(A%zdata)
		end select
		return
	end subroutine
...
! dot product DO NOT conjugating the first vector,The Tensor will be regard as a vector
	...
	subroutine product_dot_int(R,A,B)	
		...
		select case(flag)
			...
			case(15)
				R=zdotu1(length, dcmplx(A%idata(1:length)), 1, B%zdata, 1)
			...
			case(25)
				R=zdotu1(length, dcmplx(A%sdata(1:length)), 1, B%zdata, 1)
			...
			case(33)
				R=ddot(length,  A%ddata, 1, B%ddata, 1)
			case(34)
				R=zdotu1(length, dcmplx(A%ddata(1:length)), 1, dcmplx(B%cdata(1:length)), 1)
			case(35)
				R=zdotu1(length, dcmplx(A%ddata(1:length)), 1, B%zdata, 1)	
			...
			case(43)
				R=zdotu1(length, dcmplx(A%cdata(1:length)), 1, dcmplx(B%ddata(1:length)), 1)
			case(44)
				R=cdotu(length, A%cdata, 1, B%cdata, 1)
			case(45)
				R=zdotu1(length, dcmplx(A%cdata(1:length)), 1, B%zdata, 1)	
				
			case(51)
				R=zdotu1(length, A%zdata, 1, dcmplx(B%idata(1:length)), 1)
			case(52)
				R=zdotu1(length, A%zdata, 1, dcmplx(B%sdata(1:length)), 1)
			case(53)
				R=zdotu1(length, A%zdata, 1, dcmplx(B%ddata(1:length)), 1)
			case(54)
				R=zdotu1(length, A%zdata, 1, dcmplx(B%cdata(1:length)), 1)
			case(55)
				R=zdotu1(length, A%zdata, 1, B%zdata, 1)	
		end select
		return
	end subroutine
...
!**************************************************************************************************************	
	...
	subroutine SVD_TData_routine(indata,U,S,V,m,n,min_MN,cut,info)
...
!X=(A^T * A)^{-1}* (A^T *B)
	...
	subroutine TData_ORGQR(Tau,T,M,N,minMN,INFO)
		...
		select case(T%classtype)
			case(2)
				call WorkingMemory%get_memory(swork,LWORK)
				call SORGQR( M, N, minMN, T%sdata, M, TAU%sdata, swork, LWORK, INFO )
			case(3)
				call WorkingMemory%get_memory(dwork,LWORK)
				call DORGQR( M, N, minMN, T%ddata, M, TAU%ddata, dwork, LWORK, INFO )
			case(4)
				call WorkingMemory%get_memory(cwork,LWORK)
				call CUNGQR( M, N, minMN, T%cdata, M, TAU%cdata, cwork, LWORK, INFO )
			case(5)
				call WorkingMemory%get_memory(zwork,LWORK)
				call ZUNGQR( M, N, minMN, T%zdata, M, TAU%zdata, zwork, LWORK, INFO )
		end select
		call WorkingMemory%free()
		return
	end subroutine
	...
	subroutine TData_ORGLQ(Tau,T,M,N,minMN,INFO)
		...
		select case(T%classtype)
			case(2)
				call WorkingMemory%get_memory(swork,LWORK)
				call SORGLQ( M, N, minMN, T%sdata, M, TAU%sdata, swork, LWORK, INFO )
			case(3)
				call WorkingMemory%get_memory(dwork,LWORK)
				call DORGLQ( M, N, minMN, T%ddata, M, TAU%ddata, dwork, LWORK, INFO )
			case(4)
				call WorkingMemory%get_memory(cwork,LWORK)
				call CUNGLQ( M, N, minMN, T%cdata, M, TAU%cdata, cwork, LWORK, INFO )
			case(5)
				call WorkingMemory%get_memory(zwork,LWORK)
				call ZUNGLQ( M, N, minMN, T%zdata, M, TAU%zdata, zwork, LWORK, INFO )
		end select
		call WorkingMemory%free()
		return
	end subroutine
...
!**********************************************************************************	
		if(proID.eq.ID1) then
			select case(Ten1%classtype)
				case(1)
					call mpi_send(Ten1%idata,Ten1%totalData,MPI_integer,ID2,tag,MPI_Comm,ierr)
				case(2)
					call mpi_send(Ten1%sdata,Ten1%totalData,MPI_real,ID2,tag,MPI_Comm,ierr)
				case(3)
					call mpi_send(Ten1%ddata,Ten1%totalData,MPI_double_precision,ID2,tag,MPI_Comm,ierr)
				case(4)
					call mpi_send(Ten1%cdata,Ten1%totalData,MPI_complex,ID2,tag,MPI_Comm,ierr)
				case(5)
					call mpi_send(Ten1%zdata,Ten1%totalData,MPI_double_complex,ID2,tag,MPI_Comm,ierr)
				case(6)
					call mpi_send(Ten1%ldata,Ten1%totalData,MPI_logical,ID2,tag,MPI_Comm,ierr)
				case(7)
					call mpi_send(Ten1%adata,max_len_of_char_in_TData*Ten1%totalData,&
		...
		if(proID.eq.ID2) then
			...
			select case(Ten2%classtype)
				case(1)
					call mpi_recv(Ten2%idata,Ten2%totalData,MPI_integer,ID1,tag,MPI_Comm,istatus,ierr)
				case(2)
					call mpi_recv(Ten2%sdata,Ten2%totalData,MPI_real,ID1,tag,MPI_Comm,istatus,ierr)
				case(3)
					call mpi_recv(Ten2%ddata,Ten2%totalData,MPI_double_precision,ID1,tag,MPI_Comm,istatus,ierr)
				case(4)
					call mpi_recv(Ten2%cdata,Ten2%totalData,MPI_complex,ID1,tag,MPI_Comm,istatus,ierr)
				case(5)
					call mpi_recv(Ten2%zdata,Ten2%totalData,MPI_double_complex,ID1,tag,MPI_Comm,istatus,ierr)
				case(6)
					call mpi_recv(Ten2%ldata,Ten2%totalData,MPI_logical,ID1,tag,MPI_Comm,istatus,ierr)
				case(7)
					call mpi_recv(Ten2%adata,max_len_of_char_in_TData*Ten2%totalData,&
...
!**********************************************************************************	
		...
		select case(Ten1%classtype)
			...
			case(2)
				call mpi_BCAST(Ten1%sdata,Ten1%totalData,MPI_real,ID,MPI_Comm,ierr)
			case(3)
				call mpi_BCAST(Ten1%ddata,Ten1%totalData,MPI_double_precision,ID,MPI_Comm,ierr)
			case(4)
				call mpi_BCAST(Ten1%cdata,Ten1%totalData,MPI_complex,ID,MPI_Comm,ierr)
			case(5)
				call mpi_BCAST(Ten1%zdata,Ten1%totalData,MPI_double_complex,ID,MPI_Comm,ierr)
			case(6)
				call mpi_BCAST(Ten1%ldata,Ten1%totalData,MPI_logical,ID,MPI_Comm,ierr)
			case(7)
				call mpi_BCAST(Ten1%adata,max_len_of_char_in_TData*Ten1%totalData,&
...
!**********************************************************************************	
	...
	subroutine MPI_SUM_TData(inTData,outTData,ierr,MPIcommon)!Do not check input data and do no allocate memery
		...
		select case(inTData%classtype)
			case(1)
				call MPI_ALLREDUCE(inTData%idata,outTData%idata,inTData%totalData,MPI_INTEGER,MPI_SUM,mpi_comm,ierr)
			case(2)
				call MPI_ALLREDUCE(inTData%sdata,outTData%sdata,inTData%totalData,MPI_real,MPI_SUM,mpi_comm,ierr)
			case(3)
				call MPI_ALLREDUCE(inTData%ddata,outTData%ddata,inTData%totalData,MPI_double_precision,MPI_SUM,mpi_comm,ierr)
			case(4)
				call MPI_ALLREDUCE(inTData%cdata,outTData%cdata,inTData%totalData,MPI_complex,MPI_SUM,mpi_comm,ierr)
			case(5)
	...
	subroutine MPI_MAX_TData(inTData,outTData,ierr,MPIcommon)!Do not check input data and do no allocate memery
		...
		select case(inTData%classtype)
			case(1)
				call MPI_ALLREDUCE(inTData%idata,outTData%idata,inTData%totalData,MPI_INTEGER,MPI_MAX,mpi_comm,ierr)
			case(2)
				call MPI_ALLREDUCE(inTData%sdata,outTData%sdata,inTData%totalData,MPI_real,MPI_MAX,mpi_comm,ierr)
			case(3)
				call MPI_ALLREDUCE(inTData%ddata,outTData%ddata,inTData%totalData,MPI_double_precision,MPI_MAX,mpi_comm,ierr)
			case default
	...
	subroutine MPI_MIN_TData(inTData,outTData,ierr,MPIcommon)!Do not check input data and do no allocate memery
		...
		select case(inTData%classtype)
			case(1)
				call MPI_ALLREDUCE(inTData%idata,outTData%idata,inTData%totalData,MPI_INTEGER,MPI_MIN,mpi_comm,ierr)
			case(2)
				call MPI_ALLREDUCE(inTData%sdata,outTData%sdata,inTData%totalData,MPI_real,MPI_MIN,mpi_comm,ierr)
			case(3)
				call MPI_ALLREDUCE(inTData%ddata,outTData%ddata,inTData%totalData,MPI_double_precision,MPI_MIN,mpi_comm,ierr)
			case default
				call writemess('ERROR in MAX Tensor')
				call error_stop
		end select
